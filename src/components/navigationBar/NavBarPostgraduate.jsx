...
export const NavBarPostgraduate = ({ onComponentChange, activeComponent, color }) => {
        ...
        <nav className="sticky top-0 shadow-sm shadow-unsij-black-950 z-50">
            <div style={navStyle} className="h-[8vh] flex items-center justify-between px-2 lg:px-0 lg:justify-around">
                ...
                <div className="hidden lg:flex lg:flex-row items-center gap-8 text-unsij-black-50 ">
                    ...
                    <button onClick={() => onComponentChange('InfoPostgraduate')}
                        className={activeComponent === 'InfoPostgraduate' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}
                    >Información general
                    </button>
                    <button onClick={() => onComponentChange('StudiesPostgraduate')}
                        className={activeComponent === 'StudiesPostgraduate' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Materias
                    </button>
                    <button onClick={() => onComponentChange('AcademicCore')}
                        className={activeComponent === 'AcademicCore' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Núcleo Académico
                    </button>
                    <button onClick={() => onComponentChange('Productivity')}
                        className={activeComponent === 'Productivity' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Productividad
                    </button>
                    <button onClick={() => onComponentChange('InfoAdditional')}
                        className={activeComponent === 'InfoAdditional' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
            ...
            >
                <div className='flex flex-col gap-4'>
                    ...
                    <button onClick={() => {
                        onComponentChange('InfoPostgraduate');
                        setIsMenuOpen(false)
                    }}
                        className={activeComponent === 'InfoPostgraduate' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}
                    >Información general
                    ...
                    <button onClick={() => {
                        onComponentChange('StudiesPostgraduate');
                        setIsMenuOpen(false)
                    }}
                        className={activeComponent === 'StudiesPostgraduate' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Materias
                    ...
                    <button onClick={() => {
                        onComponentChange('AcademicCore');
                        setIsMenuOpen(false)
                    }}
                        className={activeComponent === 'AcademicCore' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Núcleo Académico
                    ...
                    <button onClick={() => {
                        onComponentChange('Productivity');
                        setIsMenuOpen(false)
                    }}
                        className={activeComponent === 'Productivity' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Productividad
                    ...
                    <button onClick={() => {
                        onComponentChange('InfoAdditional');
                        setIsMenuOpen(false)
                    }}
                        className={activeComponent === 'InfoAdditional' ? 'text-unsij-green-500 font-bold' : 'text-unsij-black-50 font-medium'}>
                        Información adicional
...
export default NavBarPostgraduate